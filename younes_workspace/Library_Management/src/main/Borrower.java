...
public class Borrower extends LibraryUser{
		...
		public Set<Fine> fines; // Contains the details of fines!
		
		public Vector<Integer> requestedResources = new Vector<Integer>();	// Contains ID's of requested resources!
		
		public Vector<Integer> issuedResources = new Vector<Integer>();	//	Contains ID's of issued Resources!
