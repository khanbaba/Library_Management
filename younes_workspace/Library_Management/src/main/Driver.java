		...
		//For Admin Login IO Interface!
			...
			while(!done){
				...
				userInput = sc.nextLine();
     			...
     			//changed with following code to be testable by scanner;
				//
//				input = Integer.parseInt(sc.nextLine());
	...
	/*****************************************/
	public void addUserIO(Admin admin,int type){		//Only Admin is allowed to enter this method!
	...
	/*****************************************/
	public void removeUserIO(Admin admin){
	...
	public void addResourceIO(Admin admin, int type){
	...
	/*****************************************/
	public void removeResourceIO(Admin admin){
		...
		int id = -1;
//		sc.nextLine(); // for test. added by younes
	...
	/************** Borrow IO ****************/
	/*****************************************/
	public void borrowIO(Borrower borrower, int type){
		...
		if(sc.hasNextInt()){
			id = sc.nextInt();
			name =  sc.nextLine();
			LibraryResource findedResource = myLibrary.findResource(id);
			resources.add(findedResource);
		}
		else{
			name = sc.nextLine();
			if(myLibrary.findResource(name)!=null){
	...
	public void returnResourceIO(Borrower borrower){
	...
	/*****************************************/
	public void deleteRequestIO(Borrower borrower){
		...
		if(sc.hasNextInt()){
			id = sc.nextInt();
			name = sc.nextLine();
			if(borrower.withdrawRequest(id)){
	...
	public void renewResourceIO(Borrower borrower){
		...
		if(sc.hasNextInt()){
			...
			name = sc.nextLine();
			resources = Library.getInstance("").findResource(name);
			for(int i =0;i<resources.size(); i++){
